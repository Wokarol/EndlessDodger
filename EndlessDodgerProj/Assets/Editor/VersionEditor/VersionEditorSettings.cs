...
public class VersionEditorSettings :EditorWindow {
	...
	static void Init () {
		VersionEditorSettings window = (VersionEditorSettings)GetWindow(typeof(VersionEditorSettings));
		window.Show();
	}
	...
	private void OnGUI () {
		...
		EditorGUILayout.Space();
		autoSetVersion = GUILayout.Toggle(autoSetVersion, "Auto set version");
		EditorGUILayout.Space();
	...
	void SaveEditorData () {
		...
		EditorPrefs.SetBool("VersionEditorSettings.AutoSetVersion", autoSetVersion);
	...
	void LoadEditorData () {
		...
		autoSetVersion = LoadBoolKey(false, "VersionEditorSettings.AutoSetVersion");
